...
<head>
  ...
  <title>Панель администратора - Главная</title>
    ...
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <?php 
            if($is_shutdown['shutdown']){
              echo<<<data
                <h6 class="badge bg-danger py-2 px-3 rounded">Режим отключения активен!</h6>
              data;
            }
          ?>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5>Аналитика бронирований</h5>
          <select class="form-select shadow-none bg-light w-auto" onchange="booking_analytics(this.value)">
            <option value="1">Последние 30 дней</option>
            <option value="2">Последние 90 дней</option>
            <option value="3">Последний год</option>
            <option value="4">За все время</option>
          </select>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-3 mb-4">
            <div class="card text-center text-primary p-3">
              <h6>Всего бронирований</h6>
              <h1 class="mt-2 mb-0" id="total_bookings">0</h1>
              <h4 class="mt-2 mb-0" id="total_amt">0 сом</h4>
            </div>
          </div>
          <div class="col-md-3 mb-4">
            <div class="card text-center text-success p-3">
              <h6>Активные бронирования</h6>
              <h1 class="mt-2 mb-0" id="active_bookings">0</h1>
              <h4 class="mt-2 mb-0" id="active_amt">0 сом</h4>
            </div>
          </div>
          <div class="col-md-3 mb-4">
            <div class="card text-center text-danger p-3">
              <h6>Отмененные бронирования</h6>
              <h1 class="mt-2 mb-0" id="cancelled_bookings">0</h1>
              <h4 class="mt-2 mb-0" id="cancelled_amt">0 сом</h4>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5>Аналитика пользователей, запросов и отзывов</h5>
