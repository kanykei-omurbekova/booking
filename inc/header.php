<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">NomadBooking</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link me-2" href="index.php">Главная</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="rooms.php">Жилье</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="facilities.php">Удобства</a>
        </li>
        <li class="nav-item">
            ...
            echo<<<data
              <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-lg-end">
                  ...
                  <li><a class="dropdown-item" href="bookings.php">Бронирования</a></li>
      ...
      <form id="login-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-circle fs-3 me-2"></i> Вход пользователя
          </h5>
          <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">Email / Мобильный</label>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="forgot-form">
        <div class="modal-header">
          <h5 class="modal-title d-flex align-items-center">
            <i class="bi bi-person-circle fs-3 me-2"></i> Забыли пароль
          </h5>
        </div>
        <div class="modal-body">
          <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
            Примечание: Ссылка для сброса пароля будет отправлена на ваш email!
          </span>
          <div class="mb-4">
            <label class="form-label">Email</label>
          ...
          <div class="mb-2 text-end">
            ...
            <button type="submit" class="btn btn-dark shadow-none">ОТПРАВИТЬ ССЫЛКУ</button>
          </div>
        </div>
      </form>
    </div>
